...
/// <summary>
/// Headless unit tests for <see cref="DeviceTransform"/> — the constrained content→device affine. They
...
/// transport agrees with <see cref="DeviceTransform.Apply"/>.
/// </summary>
public class DeviceTransformTests
{
    ...
    {
        var id = DeviceTransform.Identity;
    ...
    public void CenteredHalf_FlipsCornersAndFixesCentre()
    {
        ...
        var t = DeviceTransform.CenteredRotation(Rotation90.Half, 100f, 80f);
    ...
    {
        var t = DeviceTransform.CenteredRotation(rot, 120f, 90f, scale: 1.75f);
    ...
    public void CenteredRotations_MapContentBoxOntoSurface()
    {
        ...
        var t = DeviceTransform.CenteredRotation(Rotation90.Cw90, 100f, 100f);
    ...
    public void Matrix3x2_Transport_AgreesWithApply()
    {
        ...
        var t = new DeviceTransform(Rotation90.Cw270, 2.5f, 12f, -7f);
    ...
    {
        var inner = new DeviceTransform(Rotation90.Cw90, 2f, 3f, 5f);
        var outer = new DeviceTransform(Rotation90.Cw90, 1.5f, -1f, 4f);
    ...
    {
        var a = new DeviceTransform(Rotation90.Cw90, 1f, 0f, 0f);
        var b = new DeviceTransform(Rotation90.Cw270, 1f, 0f, 0f);
